...
if ( ! class_exists( 'WP_Travel' ) ) :
	...
	final class WP_Travel {
		...
		private function define_constants() {
			...
			self::define( 'WP_TRAVEL_POST_TITLE', 'trips' );
			self::define( 'WP_TRAVEL_POST_TITLE_SINGULAR', 'trip' );
		...
		public function load_textdomain() {
			...
			if( apply_filters( 'wp_travel_load_text_domain_from_mo_files', false ) == true ){
		...
		public function includes() {
			...
			include sprintf( '%s/inc/cart-logger.php', WP_TRAVEL_ABSPATH );			
			...
			include sprintf( '%s/inc/trip-reminder-email.php', WP_TRAVEL_ABSPATH );
		...
		public static function reject_cache_in_checkout() {
			...
			// @since 4.4.4
			do_action( 'wp_travel_reject_checkout_cache_plugin_action', $support_plugins );
